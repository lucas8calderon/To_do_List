...
public final class ActivitySaveTaskBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText observacao;
  ...
  private ActivitySaveTaskBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MaterialTextView mtvMessage, @NonNull TextInputEditText observacao,
      @NonNull TextInputLayout tilDate, @NonNull TextInputLayout tilHour,
  ...
  public static ActivitySaveTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.observacao;
      TextInputEditText observacao = ViewBindings.findChildViewById(rootView, id);
      if (observacao == null) {
        break missingId;
      }
      ...
      return new ActivitySaveTaskBinding((ConstraintLayout) rootView, btnCancel, btnSaveTask,
          guideEnd, guideStart, mtvMessage, observacao, tilDate, tilHour, tilTitle, toolbar);
    }
